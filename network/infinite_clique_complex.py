...
from cpp_plugin.build.release.cpp_plugin import InfiniteCliqueComplex as CppInfiniteCliqueComplex
...
class InfiniteCliqueComplexSet:
    """A set of infinite network."""

    def __init__(self, infinite_networks: list[InfiniteCliqueComplex]) -> None:
        """Construct an empty network."""
        self._infinite_networks = infinite_networks

    @log_function_name
    def get_largest_network(self) -> InfiniteCliqueComplex | None:
...
class InfiniteCliqueComplex(Network):
    """Represent an "infinite network" in which network size effects do not play a role."""

    def __init__(self, cpp_network: CppInfiniteCliqueComplex) -> None:
        """Construct an empty network."""
        super().__init__()
