...
AdrcmModel::Parameters::Parameters(const py::array_t<double> &parameters_in)
{
    const auto model_parameters = numpy_to_vector_1d<double>(parameters_in);
...
AdrcmModel::AdrcmModel(const py::array_t<double> &parameters)
